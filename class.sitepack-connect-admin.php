...
//        add_action('admin_init', [$this, 'registerSettings']);
    ...
    public function adminPages()
    {
        ...
        add_menu_page(
            __('sitepack dashboard', 'sitepack'),
            'SitePack',
            'manage_options',
            'sitepack',
    ...
    {
        update_option(self::SITEPACK_API_KEY, md5(self::SITEPACK_API_KEY . rand(1, 1000) . time() - rand(1000, 2000)));
        update_option(
            self::SITEPACK_API_SECRET,
            md5(self::SITEPACK_API_SECRET . rand(3, 4000) . time() + rand(1000, 2000))
        );
    }

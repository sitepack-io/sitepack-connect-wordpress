...
class SitePackStockLocation implements \JsonSerializable
{
     ...
     * @throws Exception
     */
    public static function fromSitePackConnectData(array $apiData): SitePackStockLocation
    {
        return new SitePackStockLocation(
